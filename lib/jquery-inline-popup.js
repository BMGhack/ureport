...
(function($) {
  ...
  $.fn.inlinePopup = function(options) {
    ...
    var placeArrow = function(c,de) {
      console.log($('#categories-wrapper').position().left);
      console.log(c.outerWidth()/2);
      var arrow     = de.find("."+inlinePopup.settings.iparrowclass),
          arrowLeft = c.position().left + ((c.outerWidth()/2) - (arrow.outerWidth()/2)) - $('#categories-wrapper').position().left;
